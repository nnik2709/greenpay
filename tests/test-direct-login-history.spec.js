...
test('Test Login History page directly after Select fix', async ({ page }) => {
  ...
  console.log('Step 1: Navigate directly to Login History page...');
  ...
  if (isOnLoginHistoryPage) {
    console.log('Step 2: Check if page content loads...');
    ...
    console.log('Body contains "All users":', bodyText?.includes('All users') || false);
  ...
  // Take a screenshot
  await page.screenshot({ path: 'test-direct-login-history.png', fullPage: true });
