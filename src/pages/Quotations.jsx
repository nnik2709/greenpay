    ...
    import { FilePlus, Search, Filter, FileText, Calendar, CheckCircle, XCircle, Send, Clock, DollarSign, Hash, Users as UsersIcon } from 'lucide-react';
    ...
    const Quotations = () => {
      ...
      const stats = [
        ...
        { title: 'Sent', value: '0', icon: Send, color: 'text-purple-600', bgColor: 'bg-purple-100' },
