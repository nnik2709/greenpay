-- ============================================================================
-- MIGRATE TO MODERN SCHEMA - Complete Migration Script
...
--
-- This script migrates data from legacy → modern, preparing for clean production state
...
-- ============================================================================
-- STEP 5: ARCHIVE LEGACY TABLES (Don't Delete - Keep as Backup)
-- ============================================================================

DO $$
BEGIN
  RAISE NOTICE 'Archiving legacy tables...';
END $$;

-- Rename legacy Passport table to archive
ALTER TABLE "Passport" RENAME TO "_archived_Passport_20251219";

DO $$
BEGIN
  RAISE NOTICE '  ✓ "Passport" → "_archived_Passport_20251219"';
  RAISE NOTICE '';
  RAISE NOTICE 'NOTE: Legacy "User" and "Role" tables are kept (authentication working)';
  RAISE NOTICE '';
END $$;
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE '3. If everything works, you can drop archived tables later:';
  RAISE NOTICE '   DROP TABLE "_archived_Passport_20251219";';
  RAISE NOTICE '';
...
-- If you see warnings or errors, ROLLBACK
